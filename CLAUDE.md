...
#### Дизайн MIGR-1 — Claude 2026-09-15 — этап 0 сделан, этап 1 готов к выпуску
...
**Этап 1 — код готов, staging готов, бой ждёт решения владельца (2026-09-15).**
...
**Staging:** функции и перенос применены, 6 поездок и 12 заявок сверены (расхождений 0). Осталось:
владелец пушит ветку `staging`, CI выкладывает функцию, e2e должны быть зелёными.

**Выпуск на бой — только с «да» владельца, строго по порядку** (иначе новая функция на старой базе
