...
#### Дизайн MIGR-1 — Claude 2026-09-15 — этапы 0 и 1 одобрены владельцем; этап 0 сделан
...
Попутно: у поездок есть поле `pricePerChild`, но сайт и сервер считают детское место как половину взрослого —
уточнить у владельца, какая цена верная.

**Что владельцу нужно решить:** одобрить этап 0 и этап 1. Оценка этапа 1 — 1–2 рабочих дня кода
Claude + прогон на staging. Остальные этапы — по одному после выпуска предыдущего.
