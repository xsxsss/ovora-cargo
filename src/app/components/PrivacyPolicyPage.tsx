  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        'Аналитика посещений: Rybbit — обезличенно, без cookie, адреса страниц с номерами и телефонами скрываются',
    ...
    },
    {
      ...
      items: [
        ...
        'Аналитических cookie нет: статистика посещений собирается без них',
